...
namespace CinemAPI.IoCContainer
{
    public class DomainPackage : IPackage
    {
        public void RegisterServices(Container container)
        {
            ...
            container.Register<IGetAvailableSeatsForProjection, GetAvailableSeatsProjectionNotActiveValidation>();

            container.Register<IMakeReservationTicket, MakeReservationTicket>();
            container.RegisterDecorator<IMakeReservationTicket, MakeReservationTicketProjectionFinishedValidation>();
            container.RegisterDecorator<IMakeReservationTicket, MakeReservationTicketProjectionAboutToStartValidation>();
            container.RegisterDecorator<IMakeReservationTicket, MakeReservationTicketSeatValidation>();
